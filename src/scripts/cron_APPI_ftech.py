...
if time.time() - os.path.getmtime(filename) > 180:
        ...
        os.system('rm -rf /tmp/tmp*; rm -rf /tmp/rust_mozprofilef*; pkill Xvfb; pkill Xephyr; pkill geckodriver; pkill firefox')
