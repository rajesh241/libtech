...
def main():
  datadir='/home/libtech/webroot/chaupalDataDashboard/reports/general/chattisgarhNregaAssets/'
  ...
  for oneWorkCode in workCodes:
    ...
    for oneFinyear in finYears:
      ...
      for block in blockNames:
        ...
        myURL='http://164.100.112.66/netnrega/citizen_html/assetscreatedblk.aspx?lflag=eng&page=b&f=1&block_code=%s&workstatus=05&project=%s&finyear=%s&state_name=CHHATTISGARH&district_name=SURGUJA&block_name=%s' %(curBlockCode,oneWorkCode,oneFinyear,block)
        print myURL
