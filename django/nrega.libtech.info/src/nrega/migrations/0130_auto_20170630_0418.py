# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-29 22:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('nrega', '0129_auto_20170629_0604'),
    ]

    operations = [
        migrations.CreateModel(
            name='VillageFPSStatus',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fpsStatus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nrega.FPSStatus')),
                ('fpsVillage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nrega.FPSVillage')),
            ],
        ),
