...
def main():
  ...
  if panchayatCode is not None:
    myPanchayats=Panchayat.objects.filter(block__district__state__isNIC=True,code=panchayatCode).order_by('musterCrawlDate')[:limit]
  else: 
    if stateCode is None:
      myPanchayats=Panchayat.objects.filter(crawlRequirement=crawlRequirement,block__district__state__isNIC=True).order_by('musterCrawlDate')[:limit]
    else:
      myPanchayats=Panchayat.objects.filter(crawlRequirement=crawlRequirement,block__district__state__code=stateCode,block__district__state__isNIC=True).order_by('musterCrawlDate')[:limit]
